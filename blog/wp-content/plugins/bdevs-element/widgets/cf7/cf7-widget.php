...
class CF7 extends BDevs_El_Widget
{
    ...
    protected function render()
    {
        ...
        <section class="contact__area p-relative z-index-1">
           <div class="container">
              <div class="row">
                          ...
                          <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                             <div class="contact__info pr-80">                                
                                <?php if ($settings['title']) : ?>
                                    <h3 class="contact__title"><?php echo bdevs_element_kses_intermediate($settings['title']); ?></h3>
                                <?php endif; ?>
    ...
    <?php elseif ($settings['design_style'] === 'style_2'): ?>
        ...
        <div class="contact-area">
            <div class="container">
                <div class="contact-bg zcontact-bg">
                    <?php if( !empty($settings['title']) ) : ?>
                    <div class="row justify-content-center">
                        <div class="col-xl-12">
                            <div class="contact-title text-center mb-65">
        ...
        <section class="contact_section clearfix d-none">
            <div class="container">
		...
		<div class="contact-area">
			<div class="container">
				<div class="contact-bg zcontact-bg">
					...
					<div class="row justify-content-center">
						<div class="col-xl-12">
							<div class="contact-wrapper subscribe__new">
	                        <?php
                                if (!empty($settings['form_id'])) {
                                    echo bdevs_element_do_shortcode('contact-form-7', [
                                        'id' => $settings['form_id'],
