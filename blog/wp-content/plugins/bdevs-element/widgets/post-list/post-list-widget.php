        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'style_2' => __('Style 2: Overlay BG', 'bdevselement'),
            ...
            <div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
                <div <?php $this->print_render_attribute_string( 'wrapper-inner' ); ?> >
                    ...
                    <div <?php $this->print_render_attribute_string( 'item' ); ?>>
                        ...
                        <div class="blog-wrapper blog-wrapper-2 mb-30">
                            <?php if ( 'yes' === $settings['feature_image'] ): ?>
                            <div class="blog-img">
                                <a href="<?php echo esc_url(get_the_permalink( $post->ID )); ?>"><?php echo get_the_post_thumbnail( $post->ID, $settings['post_image_size'] ); ?></a>
                            </div>
                            ...
                            <?php endif; ?>
                                ...
                                <div class="blog_btn mt-20">
                                    <a href="<?php echo esc_url(get_the_permalink( $post->ID )); ?>" class="btn">view details </a>
                                </div>
                            </div>
                        </div>
                    </div>
